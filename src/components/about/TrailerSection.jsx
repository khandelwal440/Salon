...
export default function TrailerSection() {
  return (
    <section id="trailer" className="section section--trailer w-full min-h-screen h-screen relative overflow-hidden bg-black" style={{ width: '100%', height: '100vh', minHeight: '100vh', display: 'block' }}>
